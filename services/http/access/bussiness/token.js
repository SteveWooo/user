...
module.exports = {
	config : {
		path : '/page/access/bussiness/token',
		method : 'get',
		middlewares : [],
		model : {
			status : 2000,
	...
	service : async (req, res, next)=>{
		...
		*/
		var payjsCallbackUrl = `${swc.config.payjs.callback_url_head}/${swc.config.server.bussiness_name}/api/access/payjs/callback?bussiness_callback_url=${query.bussiness_callback_url}&appid=${query.appid}`;
